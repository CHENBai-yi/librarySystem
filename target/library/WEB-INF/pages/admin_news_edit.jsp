...
<form role="form" action="admin_news_edit_do.html?newsId=${news.newsId}" method="post">
    <div class="form-group" style="position: relative; top: 100px;left: 300px;">
        ...
        <input type="text" class="form-control" placeholder="输入标题...." style="width: 300px;" name="newsTitle" id="newsTitle" value="${news.newsTitle}">
        <label for="newsContent">公告内容</label>
        <textarea class="form-control" rows="15" cols="20" placeholder="输入公告的内容...." style="width: 600px;" name="newsContent" id="newsContent">${news.newsContent}</textarea>
