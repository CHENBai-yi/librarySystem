...
<head>
	...
	<script>jQuery.extend(Drupal.settings, {
        ...
        "pathPrefix": "cn\/",
        "ajaxPageState": {
            "theme": "pkulib2018", "theme_token": "L9HSyRB6jKl0EEs-sCiVmns3L4R9FUmsG4fbqll-5Rw", "js": {
        ...
        "better_exposed_filters": {"views": {"news_list": {"displays": {"page": {"filters": []}}}}},
...
<body class="html not-front not-logged-in no-sidebars page-news page-news-notices i18n-zh-hans section-news">
<div id="skip-link">
		...
		<section class="col-sm-12">
			...
			<div class="region region-content">
				<section id="block-system-main" class="block block-system clearfix">
					...
					<div class="view view-news-list view-id-news_list view-display-id-page view-dom-id-f231dede1f021aa12b05aa68ed79deba">
						<div class="view-header">
							<div class="content-list-news-tabs">
								<h2>最新消息</h2>
								<p>
									欢迎您阅读我们最近的新闻和公告。</p>
								<ul>
