		...
		<div class="collapse navbar-collapse" id="example-navbar-collapse">
			<ul class="nav navbar-nav navbar-left">
				...
				<li <c:if test="${current eq 1}">class="active"</c:if>>
					<a href="<c:url value="/reader_books.html"/>" style="color: white">
						图书查询
					</a>
				</li>
				<li <c:if test="${current eq 2}">class=" dropdown active"</c:if>>
					...
					<ul class="dropdown-menu">
						<li><a href="<c:url value="/reader_info.html"/>">个人信息</a></li>
						<li class="divider"></li>
						<li><a href="<c:url value="/mylend.html"/>"> 我的借还</a></li>
					</ul>
				</li>
				<li <c:if test="${current eq 3}">class="dropdown active"</c:if>>
					...
					<ul class="dropdown-menu">
						<li><a href="<c:url value="/reader_appoint_list.html"/>">我的预约</a></li>
						<li class="divider"></li>
						<li><a href="<c:url value="/reader_appoint_show.html"/>">预约</a></li>
					</ul>
				</li>
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="<c:url value="/reader_info.html"/>">
					<c:choose>
