...
<head>
	...
	<link href="/portal/cn/dzzn/gzzd/ruguanguanli" rel="canonical"/>
	<link href="/portal/cn/node/5448" rel="shortlink"/>
	<link href="https://www.lib.pku.edu.cn/portal/sites/default/files/favicon.ico" rel="shortcut icon"
	      type="image/vnd.microsoft.icon"/>
	<title>用户入馆管理办法</title>
	...
	<script>jQuery.extend(Drupal.settings, {
        ...
        "pathPrefix": "cn\/",
        "ajaxPageState": {
            "theme": "pkulib2018", "theme_token": "Iry6iRZOylK6m8vvRwr1zK4RL7MbNutjdPY0Ev5OBCM", "js": {
...
<body class="html not-front not-logged-in one-sidebar sidebar-first page-node page-node- page-node-5448 node-type-page i18n-zh-hans section-dzzn">
<div id="skip-link">
	...
	<div class="row">
		<section class="col-sm-9">
			<ol class="breadcrumb">
				...
				<li><span class="nolink" title="">读者指南</span></li>
				<li><a href="<c:url value="<%=Constants.AccessPageUrl.RUGUANGUANLI%>"/>">规章制度</a></li>
				<li class="active">用户入馆管理办法</li>
			</ol>
			<a id="main-content"></a>
			<h1 class="page-header">用户入馆管理办法</h1>
			<div class="region region-content">
				<section class="block block-system clearfix" id="block-system-main">
					<article about="/portal/cn/dzzn/gzzd/ruguanguanli" class="node node-page clearfix" id="node-5448"
					         typeof="foaf:Document">
						<header>
							<span class="rdf-meta element-hidden" content="用户入馆管理办法" property="dc:title"></span><span
								class="rdf-meta element-hidden" content="0" datatype="xsd:integer"
								property="sioc:num_replies"></span></header>
						<div class="field field-name-body field-type-text-with-summary field-label-hidden">
							<div class="field-items">
								<div class="field-item even" property="content:encoded"><p>
									所有持有效借阅证件的用户均可刷卡（人脸识别）入馆。未办理或开通借阅证件的用户须根据《借阅证件管理办法》办理或开通后，方可凭证（人脸识别）入馆。</p>
									<p>
										所有用户进入和使用图书馆时应了解并遵守《<a class="contentlink"
										                                          href="/portal/dzzn/gzzd/wenminggongyue">文明读者公约</a>》，自觉遵守图书馆的各项规章制度并维护馆内秩序，服从图书馆工作人员的管理。
									</p>
								</div>
							</div>
						</div>
