...
<head>
	...
	<script>jQuery.extend(Drupal.settings, {
        ...
        "pathPrefix": "cn\/",
        "ajaxPageState": {
            "theme": "pkulib2018", "theme_token": "XRFm7k2BS4WlTiDe3rRy6U6bG09wwdXmh5hzP-De6IM", "js": {
...
<body class="html not-front not-logged-in one-sidebar sidebar-first page-node page-node- page-node-5447 node-type-page i18n-zh-hans section-dzzn">
<div id="skip-link">
	...
	<div class="row">
		<section class="col-sm-9">
			<ol class="breadcrumb">
				...
				<li><a class="active" href="<c:url value="<%=Constants.AccessPageUrl.WENMINGGONGYUE%>"/>">规章制度</a>
				</li>
				<li class="active">文明读者公约</li>
			</ol>
			<a id="main-content"></a>
			<h1 class="page-header">文明读者公约</h1>
			<div class="region region-content">
				<section class="block block-system clearfix" id="block-system-main">
					
					
					<article about="/portal/cn/dzzn/gzzd/wenminggongyue" class="node node-page clearfix" id="node-5447"
					         typeof="foaf:Document">
						<header>
                            <span class="rdf-meta element-hidden" content="文明读者公约"
						...
						<div class="field field-name-body field-type-text-with-summary field-label-hidden">
							<div class="field-items">
								<div class="field-item even" property="content:encoded"><p>
									1. 凭证入馆</p>
									<p>
										凭本人有效校园卡、借书证或阅览证刷证（或刷脸）入馆出馆，检测仪报警时应配合管理人员的检查。</p>
									<p>
										2. 保持安静</p>
									<p>
										保持图书馆内安静，手机或电脑等设备调至静音。不在馆内公共区域喧哗、朗读或大声接打手机，尤其不要在阅览区域接打手机。</p>
									<p>
										3. 安全防火</p>
									<p>
										图书馆是重点防火单位，不要在馆内任何地方吸烟、用火。</p>
									<p>
										4. 保持清洁</p>
									<p>
										保持馆内清洁卫生，不要随地吐痰，乱扔废弃物，不携带任何食品进入图书馆。</p>
									<p>
										5. 爱护公物</p>
									<p>
										爱护图书馆的书刊资料，文明阅览。</p>
									<p>
										爱护馆内设施设备，不随意涂抹刻画和破坏设备，不随意挪动阅览桌椅。</p>
									<p>
										未经许可，不在馆内张贴或散发广告及其他宣传品。</p>
									<p>
										6. 文明礼貌</p>
									<p>
										进入图书馆应着装整齐，举止文明，礼貌待人，不妨碍他人查阅资料，不抢占阅览座位，维护文明优雅的图书馆环境。</p>
									<p>
										7. 遵守规定</p>
									<p>
										自觉遵守图书馆的各项规章制度并维护馆内秩序，服从图书馆工作人员的管理。</p>
									<p>
										8. 维护知识产权</p>
									<p>
										遵守知识产权的有关规定，合理使用和复制图书馆文献资源，不得将所获得的文献提供给校外人员，不得将所获得的文献资料用于非法牟利。</p>
								</div>
							</div>
						</div>
