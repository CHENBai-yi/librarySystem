...
<div class="panel panel-default" style="width: 600px;position: relative;top: 80px;left:300px">
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div><span>预约人数:</span><p>[${appointinfo.appointNum}]</p></div>
            <div><span>状态:</span>
                <c:choose>
            ...
            <div><span>允许预约角色:</span><p>${appointinfo.appointRole}</p></div>
            <div><span>预约截止时间:</span><p>${appointinfo.appointTime}</p></div>
            <div><span>入馆开始时间:</span><p>08:00</p></div>
            <div><span>入馆结束时间:</span><p>21:00</p></div>
            <div><span>入馆地点:</span><p>图书馆</p></div>
            <div><span>入馆说明:</span><p>${appointinfo.appointIns}</p></div>
        </div>
        <a href="reader_appoint.html" class="btn btn-success col-lg-2" style="position: relative;left: 300px; top: 30px;">我要预约</a>
    </div>
