...
<c:if test="${msg!=null}">
	<div aria-atomic="true" aria-live="assertive"
	     class="position-fixed toast align-items-center text-bg-primary border-0 "
	     id="liveToast" role="alert">
		
		<div class="d-flex">
			<button aria-label="Close" class="btn-close btn-close-white m-auto" data-bs-dismiss="toast"
			        type="button"></button>
