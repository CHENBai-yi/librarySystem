!function () {
    "use strict";
    !function (t) {
        var e = t.screen, n = e.width, r = e.height, a = t.navigator.language, i = t.location, o = t.localStorage,
            u = t.document, c = t.history, s = i.hostname, f = i.pathname, l = i.search, d = u.currentScript;
        if (d) {
            var m = "data-", p = d.getAttribute.bind(d), h = p(m + "website-id"), v = p(m + "host-url"),
                g = "false" !== p(m + "auto-track"), b = p(m + "do-not-track"), y = p(m + "domains") || "",
                S = y.split(",").map((function (t) {
                    return t.trim()
                })), k = (v ? v.replace(/\/$/, "") : d.src.split("/").slice(0, -1).join("/")) + "/api/send",
                w = n + "x" + r, N = /data-umami-event-([\w-_]+)/, T = m + "umami-event", j = 300,
                A = function (t, e, n) {
                    var r = t[e];
                    return function () {
                    ...
                    return o && o.getItem("umami.disabled") || b && function () {
                        var e = t.doNotTrack, n = t.navigator, r = t.external, a = "msTrackingProtectionEnabled",
                    ...
                    if (!E()) {
                        ...
                        return void 0 !== L && (e["x-umami-cache"] = L), fetch(k, {
                            method: "POST",
            ...
            var L, P, _, q, C, I = "" + f + l, J = u.referrer, M = u.title;
            if (g && !E()) {
                c.pushState = A(c, "pushState", O), c.replaceState = A(c, "replaceState", O), C = function (t) {
                    var e = t.getAttribute.bind(t), n = e(T);
                    if (n) {
                        var r = {};
                    ...
                    var e = t.target, n = "A" === e.tagName ? e : function (t, e) {
